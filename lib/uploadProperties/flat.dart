...
class FlatUploadScreen extends StatefulWidget {
  const FlatUploadScreen({Key? key}) : super(key: key);
  @override
  State<FlatUploadScreen> createState() => _FlatUploadScreenState();
}

class _FlatUploadScreenState extends State<FlatUploadScreen> {
