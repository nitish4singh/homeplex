...
class ShutterUploadScreen extends StatefulWidget {
  const ShutterUploadScreen({Key? key}) : super(key: key);
  @override
  State<ShutterUploadScreen> createState() => _ShutterUploadScreenState();
}

class _ShutterUploadScreenState extends State<ShutterUploadScreen> {
                        ...
                        child: Wrap(
                          children: <Widget>[
                            ChoiceChip(
                              ...
                              selected: floor == '1st floor',
                              onSelected: (bool selected) {
                                setState(() {
                                  floor = selected ? "1st floor" : '';
                                });
                              },
                            ),
                            ChoiceChip(
                              ...
                              selectedColor: Colors.blue,
                              backgroundColor: Colors.grey[300],
                              label: const Text("2nd floor"),
                              selected: floor == "2nd floor",
                              onSelected: (bool selected) {
                                setState(() {
                                  floor = selected ? "2nd floor" : '';
                                });
                              },
                            ),
                            ChoiceChip(
                              ...
                              selectedColor: Colors.blue,
                              backgroundColor: Colors.grey[300],
                              label: const Text("3rd floor"),
                              selected: floor == "3rd floor",
                              onSelected: (bool selected) {
                                setState(() {
                                  floor = selected ? "3rd floor" : '';
                                });
                              },
                            ),
                            ChoiceChip(
                            ...
                            ChoiceChip(
                              ...
                              selected: floor == "other",
                              onSelected: (bool selected) {
                                setState(() {
                                  floor = selected ? "other" : '';
                                });
                              },
                            ),
                          ],
