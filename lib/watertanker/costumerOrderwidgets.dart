...
class CostumerOrderWidets extends StatefulWidget {
  final TankerOrder tankerOrder;
  const CostumerOrderWidets({
    Key? key,
    required this.tankerOrder,
  }) : super(key: key);
  @override
...
class _CostumerOrderWidetsState extends State<CostumerOrderWidets> {
  ...
  Widget build(BuildContext context) {
    var dateTime = DateTime.parse(widget.tankerOrder.pickupdate);
                    ...
                    Row(
                      children: <Widget>[
                        Padding(
                            ...
                            child: Text(
                              'OrderId :  ${widget.tankerOrder.orderid}',
                    ...
                    Row(
                      children: <Widget>[
                        Padding(
                            padding: const EdgeInsets.fromLTRB(15, 5, 0, 0),
                            child: Text(
                              'Driver no :  ${widget.tankerOrder.driverphoneno}',
                              style: const TextStyle(
                      ...
                      children: <Widget>[
                        Flexible(
                          child: Padding(
                            ...
                            child: Text(
                              'Driver Name:  ${widget.tankerOrder.drivername}',
                              style: const TextStyle(
                                  color: Colors.black, fontSize: 17),
                            ),
                          ),
                        ...
                        Flexible(
                          child: Padding(
                            padding:
                                const EdgeInsets.fromLTRB(10.0, 5.0, 1.0, 1.0),
                            child: Text(
                              'pickupTime: ${widget.tankerOrder.pickuptime}',
                              style: const TextStyle(
                                  color: Colors.black, fontSize: 17),
                            ),
                          ),
