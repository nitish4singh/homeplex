...
import 'package:Homeplex/widgets/eco_button.dart';
import 'package:Homeplex/widgets/ecotextfield.dart';

class WaterTankerDriverProfileScreen extends StatefulWidget {
  const WaterTankerDriverProfileScreen({Key? key}) : super(key: key);
  @override
  State<WaterTankerDriverProfileScreen> createState() =>
      _WaterTankerDriverProfileScreenState();
}

class _WaterTankerDriverProfileScreenState
    extends State<WaterTankerDriverProfileScreen> {
  String? profilePic;
  String? liciencephoto;
