...
class ElectricalApplience extends StatefulWidget {
  const ElectricalApplience({
    Key? key,
  }) : super(key: key);
  @override
  State<ElectricalApplience> createState() => _ElectricalApplienceState();
}

class _ElectricalApplienceState extends State<ElectricalApplience> {
  ...
  final List<String> _labourtype = <String>[
    'New installation Washing Machine \n Refrigerator ,Gas Geyser , Heater,etc',
    'Repair & Maintenance',
    'Solar Water Heater',
    'Other'
  ];
