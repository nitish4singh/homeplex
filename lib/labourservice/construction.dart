...
class ConstructionWork extends StatefulWidget {
  const ConstructionWork({
    Key? key,
  }) : super(key: key);
  @override
  State<ConstructionWork> createState() => _ConstructionWorkState();
}

class _ConstructionWorkState extends State<ConstructionWork> {
