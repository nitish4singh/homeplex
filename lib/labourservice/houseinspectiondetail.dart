...
import 'package:Homeplex/screens/success.dart';
...
class Houseinspectiondetail extends StatefulWidget {
  final HomeInspectionModel homeInspectionModel;
  const Houseinspectiondetail({
    Key? key,
    required this.homeInspectionModel,
  }) : super(key: key);
  @override
  State<Houseinspectiondetail> createState() => _HouseinspectiondetailState();
}

class _HouseinspectiondetailState extends State<Houseinspectiondetail> {
                                                ...
                                                children: [
                                                  RichText(
                                                    text: TextSpan(children: [
                                                      ...
                                                      TextSpan(
                                                          text:
                                                              "having Service Charge ${widget.homeInspectionModel.servicecharge} ",
                                                          style: const TextStyle(
                                                              color:
                                                                  Colors.blue,
                                                              fontSize: 17,
                                                    ...
                                                    child: ElevatedButton(
                                                      onPressed: () async {
                                                        if (formKey
                                                          ...
                                                          String output = await HouseInspectionCloud().uploadOrderinspectionToDatabase(
                                                              deliverylocation:
                                                              ...
                                                              engineername: widget
                                                                  ...
                                                                  .engineername
                                                                  .toString(),
                                                              uplodername: usernameController
                                                                  .text,
                                                              speciality: widget
                                                                  .homeInspectionModel
                                                                  .speciality
