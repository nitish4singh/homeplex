...
class LalitpurFirstScreen extends StatefulWidget {
  const LalitpurFirstScreen({Key? key}) : super(key: key);
  @override
  State<LalitpurFirstScreen> createState() => _LalitpurFirstScreenState();
}

class _LalitpurFirstScreenState extends State<LalitpurFirstScreen>
  ...
  void getDataAll() async {
    List<Widget> temp70 = await RentCloudFirestoreClass()
        .getProductsByAllCatogary("lalitpur", "yes");
    setState(() {
      alldata = temp70;
    });
  }
  ...
  void getDatahouse() async {
    List<Widget> temp70 = await RentCloudFirestoreClass()
        .getProductsByCatogary("lalitpur", "house", "yes");
    setState(() {
      onlyhouse = temp70;
    });
  }
  ...
  void getDataOffice() async {
    List<Widget> temp70 = await RentCloudFirestoreClass()
        .getProductsByOffice("lalitpur", "office", "yes");
    setState(() {
      onlyoffice = temp70;
    });
  }
  ...
  void getDataroom() async {
    List<Widget> temp70 = await RentCloudFirestoreClass()
        .getProductsByCatogary("lalitpur", "room", "yes");
    setState(() {
      onlyroom = temp70;
    });
  }
  ...
  void getDataflat() async {
    List<Widget> temp70 = await RentCloudFirestoreClass()
        .getProductsByCatogary("lalitpur", "flat", "yes");
    setState(() {
      onlyflat = temp70;
    });
  }
  ...
  void getDatashutter() async {
    List<Widget> temp70 = await RentCloudFirestoreClass()
        .getProductsByCatogary("lalitpur", "shutter", "yes");
    setState(() {
      onlyshutter = temp70;
    });
  }
  ...
  void getDataappartment() async {
    List<Widget> temp70 = await RentCloudFirestoreClass()
        .getProductsByCatogary("lalitpur", "appartment", "yes");
    setState(() {
