...
class KtmFirstScreen extends StatefulWidget {
  const KtmFirstScreen({Key? key}) : super(key: key);
  @override
  State<KtmFirstScreen> createState() => _KtmFirstScreenState();
}

class _KtmFirstScreenState extends State<KtmFirstScreen>
  ...
  void getDataAll() async {
    List<Widget> temp70 = await RentCloudFirestoreClass()
        .getProductsByAllCatogary("kathmandu", "yes");
    setState(() {
      alldata = temp70;
    });
  }
  ...
  void getDatahouse() async {
    List<Widget> temp70 = await RentCloudFirestoreClass()
        .getProductsByCatogary("kathmandu", "house", "yes");
    setState(() {
      onlyhouse = temp70;
    });
  }
  ...
  void getDataroom() async {
    List<Widget> temp70 = await RentCloudFirestoreClass()
        .getProductsByCatogary("kathmandu", "room", "yes");
    setState(() {
      onlyroom = temp70;
    });
  }
  ...
  void getDataflat() async {
    List<Widget> temp70 = await RentCloudFirestoreClass()
        .getProductsByCatogary("kathmandu", "flat", "yes");
    setState(() {
      onlyflat = temp70;
    });
  }
  ...
  void getDatashutter() async {
    List<Widget> temp70 = await RentCloudFirestoreClass()
        .getProductsByCatogary("kathmandu", "shutter", "yes");
    setState(() {
      onlyshutter = temp70;
    });
  }
  ...
  void getDataappartment() async {
    List<Widget> temp70 = await RentCloudFirestoreClass()
        .getProductsByCatogary("kathmandu", "appartment", "yes");
    setState(() {
