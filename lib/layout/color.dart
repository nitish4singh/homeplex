...
class AppTheme {
  ...
  static Color secondary = const Color(0xFF0763BD).withOpacity(0.5);
  ...
  static Color shadow = const Color(0xFFBCBCBC).withOpacity(0.3);
  static  Color borderCard = const Color(0xFF707070).withOpacity(0.5);
  static const Color fb = Color(0xFFFF66B8);
  ...
  static final TextTheme darkTextTheme = TextTheme(
   ...
   // 7: _headline7.copyWith(color: Colors.white),
